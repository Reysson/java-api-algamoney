package com.reysson.algamoney.exceptionhandler;
...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex, WebRequest request) {
        ...
        return handleExceptionInternal(ex, erros, HttpHeaders.EMPTY, HttpStatus.NOT_FOUND, request);
    }

    private List<Erro> criarListaDeErros(BindingResult results) {
        List<Erro> erros = new ArrayList<>();

        for (FieldError fieldErros : results.getFieldErrors()) {
